...
{
    internal sealed class AstConciseCorrelatedSubqueryLookupStage : AstStage
    {
        ...
        public AstConciseCorrelatedSubqueryLookupStage(
            string from,
            string localField,
            string foreignField,
        ...
        public override AstNodeType NodeType => AstNodeType.ConciseCorrelatedSubqueryLookupStage;
        public AstPipeline Pipeline => _pipeline;

        public override AstNode Accept(AstNodeVisitor visitor)
        {
            return visitor.VisitConciseCorrelatedSubqueryLookupStage(this);
        }
        ...
        public AstConciseCorrelatedSubqueryLookupStage Update(IReadOnlyList<AstComputedField> let, AstPipeline pipeline)
        {
            ...
            return new AstConciseCorrelatedSubqueryLookupStage(_from, _localField, _foreignField, let, pipeline, _as);
        }
    }
}
