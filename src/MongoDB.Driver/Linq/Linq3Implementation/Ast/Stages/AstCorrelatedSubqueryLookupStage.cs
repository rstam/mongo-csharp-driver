...
{
    internal sealed class AstCorrelatedSubqueryLookupStage : AstStage
    {
        ...
        public AstCorrelatedSubqueryLookupStage(
            string from,
        ...
        public override AstNodeType NodeType => AstNodeType.CorrelatedSubqueryLookupStage;
        public AstPipeline Pipeline => _pipeline;

        public override AstNode Accept(AstNodeVisitor visitor)
        {
            return visitor.VisitCorrelatedSubqueryLookupStage(this);
        }
        ...
        public AstCorrelatedSubqueryLookupStage Update(IReadOnlyList<AstComputedField> let, AstPipeline pipeline)
        {
            ...
            return new AstCorrelatedSubqueryLookupStage(_from, let, pipeline, _as);
        }
    }
}
