...
{
    internal static class MqlSizeMethodToFilterTranslator
    {
        public static AstFilter Translate(MqlTranslationContext context, MethodCallExpression expression)
        {
            ...
            if (method.Is(MqlMethod.Size))
            {
                ...
                var size = MqlExpressionToConstantTranslator.Translate<int>(sizeExpression, expression);
