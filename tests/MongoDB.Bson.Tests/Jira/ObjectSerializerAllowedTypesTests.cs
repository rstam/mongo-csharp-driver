...
namespace MongoDB.Bson.Tests.Jira
{
    public class ObjectSerializerAllowedTypesTests
    {
        ...
        {
            var json = "{ Object : { _t : 'MongoDB.Bson.Tests.Jira.ObjectSerializerAllowedTypesTests+Allowed, MongoDB.Bson.Tests', X : 1  } }";
        ...
        {
            var json = "{ Object : { _t : 'MongoDB.Bson.Tests.Jira.ObjectSerializerAllowedTypesTests+NotAllowed, MongoDB.Bson.Tests', X : 1  } }";

            var exception = Record.Exception(() => BsonSerializer.Deserialize<C>(json));

            exception.Should().BeOfType<FormatException>();
            exception.Message.Should().Be("An error occurred while deserializing the Object property of class MongoDB.Bson.Tests.Jira.ObjectSerializerAllowedTypesTests+C: Type MongoDB.Bson.Tests.Jira.ObjectSerializerAllowedTypesTests+NotAllowed is not configured as an allowed type for this instance of ObjectSerializer.");
        }
        ...
        public void Serialize_should_throw_when_serializing_a_not_allowed_type()
        {
            ...
            exception.Message.Should().Be("Type MongoDB.Bson.Tests.Jira.ObjectSerializerAllowedTypesTests+NotAllowed is not configured as an allowed type for this instance of ObjectSerializer.");
        }
