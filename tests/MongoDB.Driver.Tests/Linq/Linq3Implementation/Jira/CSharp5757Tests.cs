...
public class CSharp5757Tests : LinqIntegrationTest<CSharp5757Tests.ClassFixture>
{
    ...
    {
        var discriminatorConvention = new AnimalDiscriminatorConvention();
        BsonSerializer.RegisterDiscriminatorConvention(typeof(Animal), discriminatorConvention);
    }
    ...
    [Fact]
    public void Filter_OfType_Mammal_should_work()
    {
    ...
    [Fact]
    public void Queryable_OfType_Mammal_should_work()
    {
        var collection = Fixture.Collection;
